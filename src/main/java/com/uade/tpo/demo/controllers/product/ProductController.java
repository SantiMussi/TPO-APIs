...
public class ProductController {
    ...
    public ResponseEntity<Object> updateProduct(
        ...
        try {
            byte[] img = null;
            if (req.getBase64img() != null && !req.getBase64img().isBlank()) {
                img = ImageManager.base64tobyteArray(req.getBase64img());
            }
    ...
    // POST /product/{productId}/stock/adjust (body: {"quantity": -3} or "5" for
    // restock )
