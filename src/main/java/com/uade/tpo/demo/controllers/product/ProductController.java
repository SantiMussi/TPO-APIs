        ...
        @RequestBody PurchaseRequest request){
            try{
                ...
                return ResponseEntity.status(404).body(
                    new PurchaseResponse(null, null, null, null, null, "One or more products not found")
                );
                
            } catch(InvalidStockException e){
                return ResponseEntity.badRequest().body(
                    new PurchaseResponse(null, null, null, null, null, "Insufficient stock for one or more products")
                    );
            }
    }
